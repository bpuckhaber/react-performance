...
Cell = withStateSlice(Cell, (state, props) => ({
  cell: state.grid[props.row][props.column],
}))
...
function DogNameInput() {
  ...
  function handleChange(event) {
    const value = {dogName: event.target.value}
    dispatch({type: 'UPDATE_DOG', value})
  }
